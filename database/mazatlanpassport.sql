...
CREATE TABLE IF NOT EXISTS `mazatlanpassport`.`users` (
  ...
  `communication_emails` TINYINT UNSIGNED NOT NULL DEFAULT 1,
  `newsletter_emails` TINYINT UNSIGNED NOT NULL DEFAULT 1,
  `marketing_emails` TINYINT UNSIGNED NOT NULL DEFAULT 1,
  `created_at` TIMESTAMP NOT NULL DEFAULT (NOW()),
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL,
  `verified_at` TIMESTAMP NULL,
