...
import VerifyAdminEmailForm from '@/app/(protected)/admin/(auth)/_components/verify-admin-email-form'

export default function VetifyAdminEmailPage () {
  return (
    <section>
